...
print("Fetching Best Buy Deal of the Day with wait=5000...")
html = fetcher.fetch_html(url, js_render=True, antibot=True, premium_proxy=True, custom_params={"proxy_country": "us", "wait": "5000"})
